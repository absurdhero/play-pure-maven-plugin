...
package play.templates {
  ...
  object ScalaTemplateCompiler {
    ...
    def compile(source: File, sourceDirectory: File, generatedDirectory: File, resultType: String, additionalImports: String = "") = {
      //val resultType = formatterType + ".Appendable"
      val formatterType = resultType + "Format"
    ...
    def compileVirtual(content: String, source: File, sourceDirectory: File, resultType: String, formatterType: String, additionalImports: String = "") = {
      ...
      val generated = parseAndGenerateCode(templateName, content.getBytes("UTF8"), source.getAbsolutePath, resultType, formatterType, additionalImports)
    ...
    def parseAndGenerateCode(templateName: Array[String], content: Array[Byte], absolutePath: String, resultType: String, formatterType: String, additionalImports: String) = {
      templateParser.parser(new CharSequenceReader(new String(content),0)) match {
